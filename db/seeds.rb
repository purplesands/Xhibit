...
amnh = Location.create(name: "American Museum of Natural History",
...
met = Location.create(name: "Metropolitan Museum of Art",
...
gugg = Location.create(name: "Solomon R. Guggenheim Museum",
  neighborhood: "Upper East Side",
  location_type_id: 2,
  cost_of_admission: 25,
...
bk_museum = Location.create(name: "Brooklyn Museum",
...
jewish_museum = Location.create(name: "Jewish Museum",
  neighborhood: "Upper East Side",
  location_type_id: 2,
  cost_of_admission: 18,
...
frick = Location.create(name: "The Frick Collection",
  neighborhood: "Upper East Side",
  location_type_id: 2,
...
ps1 = Location.create(name: "MoMA PS1",
...
city_hall = Location.create(name: "City Hall Park",
...
bowling_green = Location.create(name: "Bowling Green",
...
bryant_park = Location.create(name: "Bryant Park",
...
randalls_island = Location.create(name: "Randall's Island",
...
highland_park = Location.create(name: "Highland Park",
...
madison_sq = Location.create(name: "Madison Square Park",
...
battery = Location.create(name: "The Battery",
  neighborhood: "Financial District",
  size: "25 acres",
  location_type_id: 1,
  cost_of_admission: 0,
...
Butterflies and moths make up a large group of insects known as the Order Lepidoptera (lep-i-DOP-ter-ah). The name—from the Greek lepido, 'scale,' and ptera, 'wings'—refers to a prominent feature of adult butterflies and moths, the tiny scales that cover the wings and the rest of the body.", location: amnh)

Event.create(start_date: DateTime.new(2018,10,6), end_date:DateTime.new(2019,5,27), title: "Backyard Wilderness", description: "The wonders of nature are closer than you think! In Backyard Wilderness, follow a young girl who discovers the intricate secrets that nature has hidden close to her front door.", location: amnh)
...
Humans domesticated horses some 6,000 years ago, and over time, we have created more than 200 breeds, from the powerful Clydesdale to the graceful Arabian. As we have shaped horses to suit our needs on battlefields, farms, and elsewhere, these animals have shaped human history. They have also captured our imagination and hearts. Millions of people rely on horses as their spirited, dedicated, much adored companions.", location: amnh)
...
Martha Rosler: Irrespective showcases both well-known and rarely seen selections from more than five decades of work. Installations, photographic series, sculpture, and video represent a practice continually evolving and reacting to the shifting contours of political life. Throughout, Rosler’s work has been characterized by intellectual rigor and sharp wit, along with a sense of urgency directed at social and political issues that remain as relevant and immediate as when they first emerged.", location: jewish_museum)
...
Whether you're an experienced birder or just looking for a fun winter activity outdoors, birding is a great way to enjoy the outdoors and stay active. Winter is a great time to spot waterfowl, bald eagles, peregrine falcons, red-tailed hawks, snowy owls, and many more bird species.", location: central_park)
